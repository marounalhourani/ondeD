            ...
            @foreach($x as $category => $games)
                <div class="category">
                    <div onclick="toggleCategory(this)" 
                        class="bg-red-600 text-2xl text-white font-bold py-2 px-6 uppercase tracking-wide cursor-pointer rounded-md shadow-lg transition duration-300 transform hover:scale-105">
                        {{ $category }}
                    </div>
